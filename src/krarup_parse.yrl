...
%%
%%
%% Modified for the krarup language.
...
Left 500 mult_op.
Unary 600 prefix_op.
% Adding atom here for now, as erl_scan doesn't recognize 'await' as a token.
Left 650 atom.
Nonassoc 700 '#'.
Nonassoc 800 ':'.
...
expr -> record_expr : '$1'.
expr -> atom expr : krarup_utils:build_await_expr('$1', '$2').
expr -> expr_remote : '$1'.
